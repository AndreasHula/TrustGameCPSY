...
//------------------------------------------------- readout block for prepared behaviour files ------------------------------------------------------------
	ifstream ifile ("/your/GameData.bin", ios::in | ios::binary| ios::ate);	//
...
//-------------------------------------------------------------------------------------------------------------------
	...
	ofstream ofs("/your/OutputParameters.bin", ofstream::out| ofstream::binary);			//output stream
	start_id= 618;
	end_id = 824;
